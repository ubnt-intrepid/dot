...
complete -c dot -n '__fish_using_command dot' -f -a 'completion'
...
complete -c dot -n '__fish_using_command dot completion' -s h -l help -d 'Prints help information'
complete -c dot -n '__fish_using_command dot completion' -s V -l version -d 'Prints version information'
